...
export default function Home() {
  const courses = [
    ...
    { name: 'SAP FICO', duration: '120 Days', icon: Database, color: 'from-purple-500 to-pink-500', image: '/logo.png', description: 'Comprehensive SAP Financial Accounting and Controlling modules with real-world business scenarios and implementations.', link: '/sap-fico-training-in-hyderabad' },
    ...
    { name: 'SAP Basis', duration: '50 Days', icon: Database, color: 'from-orange-500 to-red-500', image: '/logo.png', description: 'SAP system administration, performance tuning, database management, and technical infrastructure maintenance.', link: '/sap-basis-training-in-hyderabad' },
    { name: 'SAP EWM', duration: '70 Days', icon: Database, color: 'from-yellow-500 to-orange-500', image: '/logo.png', description: 'Extended Warehouse Management solution covering inventory optimization, warehouse processes, and logistics automation.', link: '/sap-ewm-training-in-hyderabad' },
    { name: 'SAP HANA Admin', duration: '40 Days', icon: Database, color: 'from-purple-600 to-pink-600', image: '/logo.png', description: 'In-memory database administration, performance optimization, and advanced analytics with SAP HANA platform.', link: '/sap-hana-admin-training-in-hyderabad' },
    { name: 'S/4 HANA Finance', duration: '40 Days', icon: Database, color: 'from-blue-600 to-cyan-600', image: '/logo.png', description: 'Next-generation ERP finance modules, real-time analytics, and digital transformation with S/4HANA Finance.', link: '/s4-hana-finance-training-in-hyderabad' },
    { name: 'SAP Leonardo', duration: '50 Days', icon: Brain, color: 'from-green-600 to-teal-600', image: '/logo.png', description: 'Explore AI, machine learning, IoT, and digital innovation platform capabilities within the SAP ecosystem.', link: '/sap-leonardo-training-in-hyderabad' },
    { name: 'SAP Security & GRC', duration: '60 Days', icon: Shield, color: 'from-red-500 to-pink-500', image: '/logo.png', description: 'Enterprise security management, governance, risk, compliance, and access control in SAP environments.', link: '/sap-security-grc-training-in-hyderabad' },
    { name: 'SAP Logistics', duration: '40 Days', icon: Database, color: 'from-indigo-600 to-purple-600', image: '/logo.png', description: 'Supply chain management, procurement, inventory control, and logistics optimization using SAP S/4HANA.', link: '/sap-s4hana-simple-logistics-training-in-hyderabad' },
