...
export default function Home() {
  const courses = [
    ...
    { name: 'Salesforce', duration: '70 Days', icon: Zap, color: 'from-green-500 to-teal-500', link: '/salesforce-training-in-hyderabad' },
    { name: 'SAP FICO', duration: '120 Days', icon: Database, color: 'from-purple-500 to-pink-500', link: '/sap-fico-training-in-hyderabad' },
    { name: 'Pega', duration: '70 Days', icon: Zap, color: 'from-pink-500 to-rose-500', link: '/pega-training-in-hyderabad' },
    { name: 'Azure DevOps & AWS Cloud', duration: '75 Days', icon: Cpu, color: 'from-indigo-500 to-purple-500', link: '/azure-devops-training-in-hyderabad' },
    { name: 'Mulesoft', duration: '45 Days', icon: Network, color: 'from-orange-500 to-red-500', link: '/mulesoft-training-in-hyderabad' },
    { name: 'SAS Clinical', duration: '120 Days', icon: Database, color: 'from-blue-500 to-indigo-500', link: '/sas-clinical-online-training-in-hyderabad' },
    { name: 'SAP Basis', duration: '50 Days', icon: Database, color: 'from-orange-500 to-red-500', link: '/sap-basis-training-in-hyderabad' },
    { name: 'SAP EWM', duration: '70 Days', icon: Database, color: 'from-yellow-500 to-orange-500', link: '/sap-ewm-training-in-hyderabad' },
    { name: 'SAP HANA Admin', duration: '40 Days', icon: Database, color: 'from-purple-600 to-pink-600', link: '/sap-hana-admin-training-in-hyderabad' },
    { name: 'S/4 HANA Finance', duration: '40 Days', icon: Database, color: 'from-blue-600 to-cyan-600', link: '/s4-hana-finance-training-in-hyderabad' },
    { name: 'SAP Leonardo', duration: '50 Days', icon: Brain, color: 'from-green-600 to-teal-600', link: '/sap-leonardo-training-in-hyderabad' },
    { name: 'SAP Security & GRC', duration: '60 Days', icon: Shield, color: 'from-red-500 to-pink-500', link: '/sap-security-grc-training-in-hyderabad' },
    { name: 'SAP Logistics', duration: '40 Days', icon: Database, color: 'from-indigo-600 to-purple-600', link: '/sap-s4hana-simple-logistics-training-in-hyderabad' },
    { name: 'Data Science', duration: '100 Days', icon: Brain, color: 'from-orange-500 to-red-500', link: '/data-science-training-in-hyderabad' },
    { name: 'Python', duration: '45 Days', icon: Code, color: 'from-yellow-500 to-orange-500', link: '/python-online-training' },
    { name: 'Python With AWS', duration: '45 Days', icon: Code, color: 'from-green-500 to-blue-500', link: '/python-with-aws-training' },
    { name: 'Workday', duration: '50 Days', icon: Users, color: 'from-purple-500 to-pink-500', link: '/workday-training-in-hyderabad' },
    { name: 'Machine Learning With Python', duration: '45 Days', icon: Brain, color: 'from-blue-500 to-purple-500', link: '/machine-learning-with-python-training-in-hyderabad' },
    { name: 'AWS With DevOps', duration: '70 Days', icon: Cpu, color: 'from-teal-500 to-cyan-500', link: '/devops-training-in-hyderabad' },
    { name: 'Informatica MDM', duration: '45 Days', icon: Database, color: 'from-pink-500 to-red-500', link: '/informatica-mdm-training' },
    { name: 'Full Stack Developer', duration: '75 Days', icon: Code, color: 'from-indigo-500 to-blue-500', link: '/full-stack-developer-training-in-hyderabad' },
    { name: 'EDI Training', duration: '45 Days', icon: Code, color: 'from-emerald-500 to-teal-500', link: '/edi-training' },
    { name: 'Hadoop', duration: '60 Days', icon: Database, color: 'from-orange-600 to-yellow-600', link: '/hadoop-online-training' }
  ];
