...
const COURSE_SLUG = 'sap-central-finance-online-training-in-hyderabad';
...
export default function SAPCentralFinanceOnlineTrainingInHyderabad() {
            ...
            <section className="bg-gradient-to-br from-blue-500/15 via-green-600/20 to-teal-500/15 backdrop-blur-sm rounded-3xl p-4 lg:p-8 md:p-12 border border-blue-400/30 shadow-2xl shadow-blue-500/10 animate-fade-in">
              ...
              <div className="text-center mb-8">
                <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 animate-slide-up">
                  ...
                  <br />
                  <span className="text-white text-3xl md:text-4xl">Training in Hyderabad</span>
                </h1>
                
                {/* Course Image - Facebook Post Dimensions */}
                <div className="relative w-full max-w-4xl mx-auto mb-8 overflow-hidden rounded-2xl shadow-2xl">
                  <Image src={_mainImageUrl}
                    alt="SAP Central Finance Training Course in Hyderabad - VR IT Solutions"
                    width={1200}
                    height={630}
