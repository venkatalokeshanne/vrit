...
export default async  function AzureDevOpsTrainingInChennai() {
  const structuredDataJson = getStructuredDataStatic('azure-devops-online-training-in-chennai');
  // Fetch metadata for dynamic hero image
  const courseData = getCourseBySlugStatic('azure-devops-online-training-in-chennai');
