  ...
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Organization",
            "name": "Best Azure DevOps Training in Chennai | Azure DevOps Online Training | VR IT Solutions",
            "url": "https://vrit-ten.vercel.app/azure-devops-training-in-chennai",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Course",
            "name": "Azure DevOps Training in Chennai",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {/* Hero Section - Azure DevOps Training In Chennai */}
              ...
              <div className="text-center mb-8">
                ...
                <div className="relative w-full max-w-4xl mx-auto mb-8 overflow-hidden rounded-2xl shadow-2xl">
                  <img
                    ...
                    alt="Azure DevOps Training Course in Chennai - VR IT Solutions"
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(getStructuredData('azure-devops-training-in-chennai'))
        }}
      />
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(getReviewStructuredData('azure-devops-training-in-chennai'))
        }}
      />
      </div>
    </>
