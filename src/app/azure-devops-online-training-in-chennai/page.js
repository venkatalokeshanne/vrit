...
export async function generateMetadata() {
  return await getPageMetadata('azure-devops-online-training-in-chennai');
}

// Generate structured data for SEO
async function getPageStructuredData() {
  const structuredData = await getStructuredData('azure-devops-online-training-in-chennai');
...
export default async  function AzureDevOpsTrainingInChennai() {
  ...
  const metadata = await getPageMetadata('azure-devops-online-training-in-chennai');
