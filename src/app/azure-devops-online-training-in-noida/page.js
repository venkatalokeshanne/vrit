...
export const metadata = getPageMetadata('azure-devops-online-training-in-noida');
  ...
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Organization",
            "name": "Best Azure DevOps Training in Noida | Azure DevOps Online Training | VR IT Solutions",
            "url": "https://vrit-ten.vercel.app/azure-devops-training-in-noida",
            ...
            "address": [
              {
                ...
                "postalCode": "500016",
                "streetAddress": "506/A, Aditya Enclave, Nilagiri Block, 5th Floor, Ameerpet, Noida Telangana."
              }
            ],
            "openingHours": [
              "Mo-Sa 8:00-21:30",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Course",
            "name": "Azure DevOps Training in Noida",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {/* Hero Section - Azure DevOps Training In Noida */}
              ...
              <div className="text-center mb-8">
                <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
                  <span className="bg-gradient-to-r from-indigo-400 to-blue-400 bg-clip-text text-transparent">
                    Azure DevOps Training In Noida
                  </span>
                </h1>
                ...
                <div className="relative w-full max-w-4xl mx-auto mb-8 overflow-hidden rounded-2xl shadow-2xl">
                  <img
                    ...
                    alt="Azure DevOps Training Course in Noida - VR IT Solutions"
                ...
                <div className="space-y-6 mb-8">
                  <div className="bg-indigo-500/10 rounded-xl p-6 border border-indigo-400/20">
                    <p className="text-indigo-100 leading-relaxed">
                      VRIT Solutions is recognized for providing Realtime Azure DevOps Training in Noida and Azure DevOps Online Training throughout world.
                    </p>
                  </div>
                  <div className="bg-blue-500/10 rounded-xl p-6 border border-blue-400/20">
                    <p className="text-blue-100 leading-relaxed">
                      VR IT Solutions is one of the best software training institute in Noida. Azure DevOps (previously known as Visual Studio Team Services (VSTS) or Visual Studio Online) is the cloud based DevOps dashboard and provided by Microsoft. Azure DevOps captures over 15 years of investment and learnings in providing tools to support software development teams.
                    </p>
                  </div>
                </div>

                <CourseActionButtons 
                  courseName="Azure DevOps Online Training in Noida"
                  showEnquireNow={true}
                  showDownload={true}
                  showCallNow={false}
                  showJoinNow={false}
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(getStructuredData('azure-devops-training-in-noida'))
        }}
      />
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(getReviewStructuredData('azure-devops-training-in-noida'))
        }}
      />
      </div>
    </>
