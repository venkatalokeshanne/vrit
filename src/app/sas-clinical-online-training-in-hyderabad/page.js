...
export const metadata = getPageMetadata('sas-clinical-online-training-in-hyderabad');
  ...
  return (
    <>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(getStructuredData('sas-clinical-online-training-in-hyderabad'))
        }}
      />
      
      {/* Review Structured Data */}
      {getReviewStructuredData('sas-clinical-online-training-in-hyderabad') && (
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify(getReviewStructuredData('sas-clinical-online-training-in-hyderabad'))
          }}
        />
      )}
      </div>
