...
const COURSE_SLUG = 'servicenow-training-in-hyderabad';// Generate metadata for this page using static data
...
export default function ServiceNowTrainingInHyderabad() {
