  ...
  return (
    <>
            ...
            "address": [
              {
                ...
                "postalCode": "560001",
                "streetAddress": "506/A, Aditya Enclave, Nilagiri Block, 5th Floor, Ameerpet, Bangalore Karnataka."
              }
            ],
            "openingHours": [
              "Mo-Sa 8:00-21:30",
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(getStructuredData('sas-clinical-training-in-bangalore'))
        }}
      />
      
      {/* Review Structured Data */}
      {getReviewStructuredData('sas-clinical-training-in-bangalore') && (
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify(getReviewStructuredData('sas-clinical-training-in-bangalore'))
          }}
        />
      )}
      </div>
