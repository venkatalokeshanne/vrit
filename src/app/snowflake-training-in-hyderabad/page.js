...
const COURSE_SLUG = 'snowflake-training-in-hyderabad';// Generate metadata for this page using static data
...
export default function SnowflakeTrainingInHyderabad() {
