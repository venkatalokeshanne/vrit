      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Organization",
            "name": "Best Workday Training in Hyderabad | Workday Online Training | VR IT Solutions",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "http://schema.org",
            "@type": "review",
            "name": "Workday Training in Hyderabad - VR IT Solutions",
            "aggregateRating": {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Course",
            "name": "Workday Training in Hyderabad",
            "description": "Comprehensive 50-day Workday training covering HCM, Finance, Security, Business Processes with 100% placement assistance",
            "provider": {
              "@type": "Organization",
              "name": "VR IT Solutions",
              "sameAs": "https://vrit-ten.vercel.app"
            },
            "educationalCredentialAwarded": "Workday Certification",
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8">
              <CourseSidebar courseName="Workday" phoneNumber="+91-9032734343" />
            </div>
          </div>
