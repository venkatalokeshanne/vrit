      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Organization",
            "name": "Best EDI Training in Hyderabad | EDI Online Training | VR IT Solutions",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "http://schema.org",
            "@type": "review",
            "name": "EDI Training in Hyderabad - VR IT Solutions",
            "aggregateRating": {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Course",
            "name": "EDI Training in Hyderabad",
            "description": "Comprehensive 45-day EDI training covering Electronic Data Interchange, Sterling B2B Integrator with 100% placement assistance",
            "provider": {
              "@type": "Organization",
              "name": "VR IT Solutions",
              "sameAs": "https://vrit-ten.vercel.app"
            },
            "educationalCredentialAwarded": "EDI Certification",
