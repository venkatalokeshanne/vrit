            ...
            <section className="bg-gradient-to-br from-pink-500/15 via-rose-600/20 to-red-500/15 backdrop-blur-sm rounded-3xl p-4 lg:p-8 md:p-12 border border-pink-400/30 shadow-2xl shadow-pink-500/10">
              <div className="text-center mb-8">
                ...
                <div className="relative w-full max-w-4xl mx-auto mb-8 overflow-hidden rounded-2xl shadow-2xl">
                  <Image src={_mainImageUrl} alt="Pega Training Course in Hyderabad - VR IT Solutions" className="w-full object-cover border-2 border-pink-400/30" style={{ aspectRatio: '1200/630' }} width={1200} height={630} />
                </div>
