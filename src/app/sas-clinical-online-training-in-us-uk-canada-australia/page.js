...
const COURSE_SLUG = 'sas-clinical-online-training-in-us-uk-canada-australia';// Generate metadata for this page using static data
            ...
            <section className="bg-gradient-to-br from-blue-500/15 via-indigo-600/20 to-purple-500/15 backdrop-blur-sm rounded-3xl p-4 lg:p-8 md:p-12 border border-blue-400/30 shadow-2xl shadow-blue-500/10">
              <div className="text-center mb-8">
                ...
                <div className="relative w-full max-w-4xl mx-auto mb-8 overflow-hidden rounded-2xl shadow-2xl">
                  <Image src={mainImageUrl} alt="SAS Clinical Online Training in US, UK, Canada, Australia - VR IT Solutions" className="w-full object-cover border-2 border-blue-400/30" style={{ aspectRatio: '1200/630' }} width={1200} height={630} />
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-teal-500/10 rounded-xl p-6 border border-teal-400/20">
                  <p className="text-teal-100 leading-relaxed">
                    VR IT Solutions is one of the software training institute in US to offer sas clinical training well focused and career-oriented training program in Clinical SAS.
                  </p>
                </div>
              </div>
            </section>
