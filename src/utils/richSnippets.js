...
export class RichSnippetsManager {
      ...
      "potentialAction": [
        {
          ...
          "target": {
            "@type": "EntryPoint",
            "urlTemplate": "https://www.vritsol.com/courses?search={search_term_string}"
          },
  ...
  static generateCourseOfferings() {
    ...
    return courses.map((course, index) => ({
      ...
      "url": `https://www.vritsol.com${course.url}`,
      "provider": {
        "@type": "Organization",
      ...
      "hasCourseInstance": [
        {
          ...
          "location": {
            ...
            "url": "https://www.vritsol.com/online-training"
          }
        },
        {
          "@type": "CourseInstance", 
    ...
    return {
      ...
      "mainEntity": {
        ...
        "itemListElement": mainSitelinks.map((link, index) => ({
          ...
          "url": `https://www.vritsol.com${link.url}`,
          "potentialAction": {
            "@type": "ReadAction",
            "target": `https://www.vritsol.com${link.url}`
          }
        }))
      }
    };
  ...
  static generateBreadcrumbSchema(breadcrumbs) {
    ...
    return {
      ...
      "itemListElement": breadcrumbs.map((crumb, index) => ({
        ...
        "item": {
          "@type": "WebPage",
          "url": `https://www.vritsol.com${crumb.url}`,
          "name": crumb.name
        }
      }))
    };
  ...
  static generateArticleSchema(courseData) {
    return {
      ...
      "image": `https://www.vritsol.com${courseData.ogImage}`,
      "author": {
        "@type": "Organization",
        "name": "VR IT Solutions"
      },
